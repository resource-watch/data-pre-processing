...
raw_data_files = [x[0] for x in raw_data_file]

'''
Process data
'''
# generate names for tif files
processed_data_files = [x[:-4]+'_edit'+x[-4:] for x in raw_data_files]
# rename the tif file
for raw, processed  in zip(raw_data_files, processed_data_files):
