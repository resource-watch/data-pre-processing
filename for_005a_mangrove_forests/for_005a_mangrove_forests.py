...
#Each unique ID in the GMW dataset has a unique ID for each year, which results in duplicate unique ID's when the shapefiles are combined
...
for shape_file in shape_files:
    ...
    df['ogc_fid'] = df['ogc_fid'].values+index_buffer
