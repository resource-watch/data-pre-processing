...
dataset_name = 'soc_093_global_terrorism_index' #check

# first, set the directory that you are working in with the path variable
# you can use an environmental variable, as we did, or directly enter the directory name as a string
# example: path = '/home/soc_093_global_terrorism_index'
...
url = ' http://visionofhumanity.org/app/uploads/2020/02/GTI-2019-overall-scores-2002-2018.xlsx' #check
...
df=pd.read_excel(raw_data_file, sheet_name="Overall Scores", header=4) # selecting 2nd as row as the column names
...
df_long = pd.melt (df, id_vars= ['Country'] , var_name = 'year', value_name = 'gti_score')
...
df_long.gti_score = df_long.gti_score.astype('float64')
