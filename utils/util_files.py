...
def download_file_from_google_drive(id, download_url, destination):
    '''
    Downloads file from google drive that needs permission to donwload large files
    INPUT   id: Google drive object id, you can find it in the id={} part of the URL
    INPUT   download_url: Google drive download url
    INPUT   destination: full file name to download file to
    RETURN  None
    '''
