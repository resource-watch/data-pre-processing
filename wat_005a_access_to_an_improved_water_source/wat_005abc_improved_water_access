## This file describes the data pre-processing that was done to create the dataset Access to an Improved Water Source (National), Access to an Improved Water Source (Urban), and Access to an Improved Water Source (Rural)
