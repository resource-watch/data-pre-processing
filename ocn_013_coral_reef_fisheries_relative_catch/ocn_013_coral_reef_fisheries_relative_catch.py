...
dataset_name = 'ocn_013_coral_reef_fisheries_relative_catch'
...
for name in vector_names:
    ...
    cmd = 'gdal_rasterize -l {} -a Decile -tr 500.0 500.0 -a_nodata -128 -te -20037125.59408577 -3768750.9896163875 20037391.091492712 3831510.076516077 -ot Byte -of GTiff {} {}'.format(name,vector_path,raster_path)
...
# no real merge happening here, but a convenient enough way to duplicate the file with correct name
